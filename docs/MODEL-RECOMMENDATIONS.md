...
These recommendations target a mid-range gaming laptop class machine:
- CPU: 16-core Intel (14th gen HX or equivalent)
- RAM: 32 GB
- GPU: 8 GB VRAM (laptop discrete)
- OS: Windows 11

Currently tested models: `qwen2.5:1.5b`, `Qwen:latest`, `llama3.2:3b`, `llama3:latest`, `gemma3:1b`
