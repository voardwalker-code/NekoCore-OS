...
2. **READ before WRITE.** If a file already exists, `[TOOL:ws_read]` it BEFORE overwriting.
...
- `[TOOL:ws_write path="..." content="..."]` — write your code to a file (COMPLETE file)
- `[TOOL:ws_append path="..." content="..."]` — add to end of an existing file
