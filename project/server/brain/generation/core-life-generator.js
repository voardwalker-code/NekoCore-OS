...
Return ONLY the JSON array, nothing else.`;
  ...
  // --- System Brief Memory ---
  const systemBriefSemantic = `${name} learned about REM System v0.9.0-alpha.4.24 — the cognitive architecture that gives ${name} persistent identity, memory, and self-reflection.`;
  const systemBriefNarrative = `REM System v0.9.0-alpha.4.24 — System Briefing for ${name}
